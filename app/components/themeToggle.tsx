            ...
            <button
                ...
                className={
                    variant === "icon"
                        ...
                        : "flex w-full items-center gap-3 rounded-md px-3 py-2 text-zinc-300 hover:bg-white/5 hover:text-white transition-colors"
                }
            >
                {mounted ? <CurrentIcon className="h-5 w-5" aria-hidden="true" /> : <span className="h-5 w-5" />}
                {variant === "labelled" && <span className="text-base capitalize">{mounted ? current.label : "Theme"}</span>}
            </button>
