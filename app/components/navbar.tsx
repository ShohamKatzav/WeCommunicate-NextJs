...
const Navbar = () => {
  ...
  return (
    <div className='container z-1'>
      <div className="navbar flex justify-between items-center h-[10vh] md:h-[5vh] md:min-h-14 text-white bg-black nav wrap-break-word">
        <div>
        ...
        {nav && (
          ...
          w-full h-[100vh] bg-linear-to-b from-black to-gray-800 text-gray-500 overflow-hidden">
            {links.map((item) => (
              shouldDisplayLink(item) &&
              <li
                key={item.id}
