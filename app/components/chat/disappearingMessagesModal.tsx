                ...
                <div className="p-6">
                    ...
                    <div className="flex gap-3">
                        ...
                        <button
                            onClick={handleSave}
                            disabled={loading || saving}
                            className="flex-1 px-4 py-2.5 bg-primary text-primary-foreground rounded-lg hover:opacity-90 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                        >
                            {saving ? (
                                <>
