...
const ChatDropdown = ({ handleLeaveRoom, chat, setChat, conversationId, participants, setReloadKey }: ChatDropdownProps) => {
        ...
        <div className="relative">
            ...
            {showDropdown && (
                <div className="absolute right-0 mt-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-50 w-48">
                    <button onClick={() => { setShowDropdown(!showDropdown); handleCleanHistory(); }}
